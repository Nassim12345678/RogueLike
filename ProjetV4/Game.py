...
from handler import heal, teleport, throw ,protect
...
class Game(object):
    ...
    """ available monsters """
    monsters = {0: [Creature("Goblin", 4,toxicity=4), Creature("Bat", 2, "W")],
                1: [Creature("Ork", 6, strength=2), Creature("Blob", 10,toxicity=3)], 5: [Creature("Dragon", 20, strength=3)]}
